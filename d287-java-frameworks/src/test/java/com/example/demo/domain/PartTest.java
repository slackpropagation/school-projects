...
class PartTest {
    ...
    @Test
    void testInventoryValidReturnsTrueWhenWithinRange() {
        partIn.setInv(10);
        partIn.setMinInventory(5);
        partIn.setMaxInventory(15);
        assertEquals(true, partIn.isInventoryValid());

        partOut.setInv(7);
        partOut.setMinInventory(2);
        partOut.setMaxInventory(10);
        assertEquals(true, partOut.isInventoryValid());
    }

    @Test
    void testInventoryValidReturnsFalseWhenOutsideRange() {
        partIn.setInv(20);
        partIn.setMinInventory(5);
        partIn.setMaxInventory(15);
        assertEquals(false, partIn.isInventoryValid());

        partOut.setInv(1);
        partOut.setMinInventory(3);
        partOut.setMaxInventory(10);
        assertEquals(false, partOut.isInventoryValid());
    }
}